...
// В промпте сознательно нет конкретных сенсорных слов-якорей: маленькая модель
// повторяет любые примеры дословно («запах...» в каждой реплике). Вместо
// перечня — требование менять фокус и первое слово от реплики к реплике.
internal const val TINY_GARDEN_SYSTEM_PROMPT =
  ...
  "Ты показываешь мир, а не пересказываешь действия игрока.\n" +
  "Каждая реплика построена иначе, чем предыдущая: другое первое слово, другой " +
  "фокус, другой масштаб — от мелочи под ногами до горизонта. Не возвращайся " +
  "к тому же ощущению два раза подряд.\n" +
  "Можешь издеваться. Мир жесток и не прощает глупости.\n\n" +
